...
import {
  ...
  User, ClipboardList, FileText, BarChart3, Video, Award, 
  UserCircle, FileCheck, Clock, BookOpenCheck, Mail, MonitorPlay, 
  HelpCircle, FileQuestion, ClipboardCheck, FileSpreadsheet, 
  FileEdit, Maximize, Minimize, Sun, Moon, School, TrendingUp, 
  Star, Target, Send, IdCard, FileBadge
} from 'lucide-react';
...
const TeacherLayout = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: ClipboardList,
      submenu: [
        { title: 'Students Attendance', path: '/teacher/attendance/students', icon: Users },
        { title: 'Class Wise Report', path: '/teacher/attendance/class-report', icon: School },
        { title: 'Students Report', path: '/teacher/attendance/student-report', icon: IdCard},
      ]
    },
    {
      title: 'Homework',
    ...
    },
    {
      ...
      icon: Star,
      submenu: [
        { title: 'Rate Behaviours', path: '/teacher/behaviour-skills/rate-behaviours', icon: Target },
        { title: 'Rate Skills', path: '/teacher/behaviour-skills/rate-skills', icon: TrendingUp },
      ]
    },
    {
      title: 'Messaging',
    ...
    },
    {
      ...
      icon: FileQuestion,
      submenu: [
        { title: 'Subject Chapters', path: '/teacher/question-paper/chapters', icon: BookOpen },
        { title: 'Question Bank', path: '/teacher/question-paper/bank', icon: HelpCircle },
        { title: 'Create Question Paper', path: '/teacher/question-paper/create', icon: FileEdit },
      ]
    },
    {
      title: 'Exams',
      icon: Award,
      submenu: [
        { title: 'Add / Update Exam Marks', path: '/teacher/exams/marks', icon: FileEdit },
        { title: 'Result Card', path: '/teacher/exams/result-card', icon: IdCard },
        { title: 'Result Sheet', path: '/teacher/exams/result-sheet', icon: FileSpreadsheet },
        { title: 'Blank Award List', path: '/teacher/exams/award-list', icon: FileBadge },
      ]
    },
    {
      title: 'Class Tests',
      icon: ClipboardCheck,
      submenu: [
        { title: 'Manage Test Marks', path: '/teacher/class-tests/marks', icon: FileEdit },
        { title: 'Test Result', path: '/teacher/class-tests/result', icon: BarChart3 },
      ]
    },
    {
      title: 'Reports',
      icon: BarChart3,
      submenu: [
        { title: 'Students Report Card', path: '/teacher/reports/student-card', icon: IdCard },
        { title: 'Student Monthly Report', path: '/teacher/reports/monthly-report', icon: FileText },
      ]
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
              ...
              <div className="relative">
                ...
                >
                  <div className="hidden sm:block text-right">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 capitalize">Teacher</p>
                  </div>
                ...
                {userMenuOpen && (
                  <div className="fixed sm:absolute inset-x-4 sm:inset-x-auto top-16 sm:top-full sm:right-0 mt-0 sm:mt-2 w-auto sm:w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-16 h-[calc(100vh-4rem)] bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 z-20 overflow-y-auto w-[85vw] max-w-xs ${
