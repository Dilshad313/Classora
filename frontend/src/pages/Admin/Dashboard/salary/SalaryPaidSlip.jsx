    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg font-medium">Loading salary slip...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Error Loading Salary Slip</h3>
              ...
              <div className="flex gap-3 justify-center">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-semibold transition-all shadow-md hover:shadow-lg"
                >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Receipt No: {salaryDetails.receiptNo}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border-2 border-gray-300 p-12 print-section">
          ...
          <div className="mb-8 p-6 bg-gray-50 rounded-xl border border-gray-200">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{salaryDetails.employee.joiningDate}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Address:</p>
                <p className="font-semibold text-gray-900">{salaryDetails.employee.address || 'N/A'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 p-6 bg-emerald-50 rounded-xl border border-emerald-200">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-gray-600">Payment Date:</p>
                <p className="font-semibold text-gray-900">{salaryDetails.salaryDate}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{salaryDetails.paidBy}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Payment Method:</p>
                <p className="font-semibold text-gray-900 capitalize">{salaryDetails.paymentMethod?.replace('_', ' ')}</p>
              </div>
            </div>
          </div>
          ...
          {salaryDetails.remarks && (
            <div className="mb-8 p-4 bg-blue-50 rounded-xl border border-blue-200">
              ...
              <p className="font-medium text-gray-900">{salaryDetails.remarks}</p>
            </div>
          )}
