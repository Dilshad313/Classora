          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 mb-6 no-print">
            ...
            <div className="flex justify-end">
              <button
                ...
                disabled={loading}
                className={`px-8 py-4 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all flex items-center gap-2 ${loading ? 'opacity-75 cursor-not-allowed' : ''}`}
              >
                {loading ? (
                  <>
