        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-center h-96">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-lg font-medium">Loading salary sheet...</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6 no-print">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold text-gray-900">{salaryData?.pagination?.total || 0}</div>
          ...
          {loading ? (
            ...
            <>
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {salaryData?.salaries && salaryData.salaries.length > 0 ? (
                      salaryData.salaries.map((salary, index) => (
                        <tr key={salary._id} className="hover:bg-purple-50 transition-colors">
                          <td className="px-4 py-4 text-gray-700 font-medium">
                            {(page - 1) * limit + index + 1}
                          </td>
                          <td className="px-4 py-4">
                            <div className="flex items-center gap-2">
                              <span className="font-semibold text-gray-900">{salary.receiptNo}</span>
                              <button 
                          ...
                          <td className="px-4 py-4 text-center">
                            <div className="flex items-center justify-center gap-2">
                              <button
                                ...
                                className="px-3 py-1 bg-cyan-600 hover:bg-cyan-700 text-white rounded-lg text-sm font-medium flex items-center gap-1 transition-colors"
                  ...
                  {salaryData?.totals && salaryData.salaries && salaryData.salaries.length > 0 && (
                    <tfoot className="bg-purple-50 border-t-2 border-purple-200">
                      <tr>
                        <td colSpan="5" className="px-4 py-4 font-bold text-gray-900 text-lg">
                        ...
                        <td className="px-4 py-4 text-right font-bold text-purple-600 text-xl">
              ...
              {salaryData?.pagination && salaryData.pagination.total > 0 && (
                <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200 no-print">
