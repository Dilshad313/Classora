                  ...
                  <thead>
                    <tr className="bg-gradient-to-r from-gray-50 to-gray-100 print:bg-gray-100">
                      ...
                      {Object.keys(timetable.timetableByDay || {}).map(dayId => {
                        const day = timetable.periods.find(p => p.dayId?._id === dayId)?.dayId;
                        return (
                          <th key={dayId} className="px-4 py-4 text-center text-sm font-bold text-gray-700 uppercase tracking-wider border-b-2 border-gray-300 print:text-xs">
                            {day?.name || 'Day'}
                          </th>
                        );
                      })}
                        ...
                        return (
                          <tr key={period._id} className={`border-b border-gray-200 ${isBreakPeriod ? 'bg-orange-50 print:bg-gray-50' : 'hover:bg-gray-50'}`}>
                            ...
                            {Object.keys(timetable.timetableByDay || {}).map(dayId => {
                              ...
                              return (
                                <td key={dayId} className="px-3 py-3 text-center border-r border-gray-200 print:py-2">
                                  {dayPeriod ? (
                                    isPeriodBreak ? (
                                    ...
                                    <span className="text-gray-400 text-sm print:text-xs">-</span>
                                  )}
                                </td>
                              );
                            })}
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-16 text-center">
            ...
            {selectedClass && (
              <button
                ...
                className="mt-4 inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all"
              >
