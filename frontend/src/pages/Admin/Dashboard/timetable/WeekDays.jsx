    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading week days...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold text-gray-900 mt-2">{stats.totalDays}</p>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold text-gray-900 mt-2">{stats.activeDays}</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {weekDays.length === 0 ? (
            <div className="col-span-full text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">No Week Days Found</h3>
              <p className="text-gray-600 mb-4">Get started by creating your first week day</p>
              <button
                onClick={() => setShowAddModal(true)}
