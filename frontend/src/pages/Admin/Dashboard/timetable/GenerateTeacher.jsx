...
const GenerateTeacher = () => {
  ...
  const getSubjectColor = (subject) => {
    if (subject === 'Break' || subject === 'Lunch Break') return 'bg-orange-50 dark:bg-orange-900/20';
    if (subject === 'Free Period') return 'bg-green-50 dark:bg-green-900/20';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6 text-sm print:hidden">
          ...
          <ChevronRight className="w-4 h-4 text-gray-400 dark:text-gray-500" />
          <span className="text-gray-900 dark:text-gray-100 font-semibold">Teacher Timetable</span>
        </div>
        ...
        <div className="mb-8 print:mb-4">
          <div className="flex items-center justify-between print:block">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 print:text-2xl print:text-center">Teacher Timetable</h1>
              <p className="text-gray-600 dark:text-gray-300 mt-1 print:text-center print:text-sm">View and download teacher-wise schedules</p>
            </div>
            <div className="flex items-center space-x-3 print:hidden">
              ...
              >
                ...
                <span className="font-medium">Class View</span>
              </button>
              <button
                onClick={handlePrint}
        ...
        {selectedTeacher && selectedTeacherData && timetable ? (
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-6">
              <div className="lg:col-span-1 bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-700 dark:to-indigo-800 rounded-2xl shadow-lg p-6 text-white print:bg-white print:text-gray-900 print:border print:border-gray-300">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 print:shadow-none">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wide">Total Periods</p>
                    <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2 print:text-2xl">{stats.totalPeriods}</p>
                  </div>
                  <div className="w-12 h-12 bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/30 rounded-2xl flex items-center justify-center print:w-10 print:h-10">
                    <Clock className="w-6 h-6 text-purple-600 dark:text-purple-400 print:w-5 print:h-5" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 print:shadow-none">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2 print:text-2xl">{stats.classPeriods}</p>
                  </div>
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 rounded-2xl flex items-center justify-center print:w-10 print:h-10">
                    <BookOpen className="w-6 h-6 text-blue-600 dark:text-blue-400 print:w-5 print:h-5" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 print:shadow-none">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wide">Free Periods</p>
                    <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2 print:text-2xl">{stats.freePeriods}</p>
                  </div>
                  <div className="w-12 h-12 bg-gradient-to-br from-green-100 to-green-200 dark:from-green-900/30 dark:to-green-800/30 rounded-2xl flex items-center justify-center print:w-10 print:h-10">
                    <UserCheck className="w-6 h-6 text-green-600 dark:text-green-400 print:w-5 print:h-5" />
                  </div>
                </div>
              </div>
            </div>
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 print:bg-gray-100">
                      <th className="px-4 py-4 text-left text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider border-b-2 border-gray-300 dark:border-gray-600 print:text-xs print:py-2">
                        Time / Day
                      </th>
                      {timetable.groupedByDay?.map(dayGroup => (
                        <th key={dayGroup.day._id} className="px-4 py-4 text-center text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider border-b-2 border-gray-300 dark:border-gray-600 print:text-xs print:py-2">
                          {dayGroup.day.name}
                        </th>
                      ))}
                    </tr>
                        ...
                        return (
                          <tr key={period._id} className={`border-b border-gray-200 dark:border-gray-700 ${isBreakPeriod ? 'bg-orange-50 dark:bg-orange-900/20 print:bg-gray-50' : 'hover:bg-gray-50 dark:hover:bg-gray-700/50'}`}>
                            ...
                            {timetable.groupedByDay?.map(dayGroup => {
                              ...
                              return (
                                <td key={dayGroup.day._id} className={`px-3 py-3 text-center border-r border-gray-200 dark:border-gray-600 ${getSubjectColor(dayPeriod?.subjectId?.name || (dayPeriod ? 'Free Period' : ''))} print:py-2`}>
                                  {dayPeriod ? (
                                    isPeriodBreakOrFree ? (
                                      <div className={`text-sm font-semibold print:text-xs ${
                                        dayPeriod.subjectId?.name === 'Free Period' ? 'text-green-700 dark:text-green-400' : 'text-orange-700 dark:text-orange-400'
                                      }`}>
                                      ...
                                      <div className="space-y-1">
                                        <div className="flex items-center justify-center space-x-1">
                                          <Users className="w-3 h-3 text-blue-600 dark:text-blue-400 print:hidden" />
                                    ...
                                    <div className="text-sm font-semibold text-green-700 dark:text-green-400 print:text-xs">
                                      Free Period
                                    </div>
                                  )}
                                </td>
            ...
            {/* Legend */}
            <div className="mt-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 print:mt-4 print:shadow-none print:page-break-before">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 rounded-lg flex items-center justify-center print:w-8 print:h-8">
                    <Users className="w-5 h-5 text-blue-600 dark:text-blue-400 print:w-4 print:h-4" />
                  </div>
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-gray-100 text-sm print:text-xs">Class</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 print:text-[10px]">Assigned class</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/30 rounded-lg flex items-center justify-center print:w-8 print:h-8">
                    <BookOpen className="w-5 h-5 text-purple-600 dark:text-purple-400 print:w-4 print:h-4" />
                  </div>
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-gray-100 text-sm print:text-xs">Subject</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 print:text-[10px]">Teaching subject</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-orange-100 to-orange-200 dark:from-orange-900/30 dark:to-orange-800/30 rounded-lg flex items-center justify-center print:w-8 print:h-8">
                    <Clock className="w-5 h-5 text-orange-600 dark:text-orange-400 print:w-4 print:h-4" />
                  </div>
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-gray-100 text-sm print:text-xs">Free Period</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 print:text-[10px]">No class assigned</p>
                  </div>
                </div>
              </div>
            </div>
