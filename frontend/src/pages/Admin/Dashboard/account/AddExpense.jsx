            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-11 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-red-500 transition-all ${
                      errors.date ? 'border-red-500 bg-red-50' : 'border-gray-300 focus:border-red-500 hover:border-gray-400'
                    }`}
                  />
                </div>
                {errors.date && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-11 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-red-500 transition-all ${
                      errors.amount ? 'border-red-500 bg-red-50' : 'border-gray-300 focus:border-red-500 hover:border-gray-400'
                    }`}
                  />
                </div>
                {errors.amount && (
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 bg-white transition-all appearance-none hover:border-gray-400"
                >
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className={`w-full pl-11 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-red-500 transition-all resize-none ${
                      errors.description ? 'border-red-500 bg-red-50' : 'border-gray-300 focus:border-red-500 hover:border-gray-400'
                    }`}
                  />
                </div>
                {errors.description && (
