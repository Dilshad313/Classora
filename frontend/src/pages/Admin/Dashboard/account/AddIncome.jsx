    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6 text-sm">
          ...
          <ChevronRight className="w-4 h-4 text-gray-400" />
          <span className="text-gray-900 font-semibold">Add Income</span>
        </div>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Record new income entry</p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-11 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-green-500 transition-all ${
                      errors.date ? 'border-red-500 bg-red-50' : 'border-gray-300 focus:border-green-500 hover:border-gray-400'
                    }`}
                  />
                </div>
                {errors.date && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-11 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-green-500 transition-all ${
                      errors.amount ? 'border-red-500 bg-red-50' : 'border-gray-300 focus:border-green-500 hover:border-gray-400'
                    }`}
                  />
                </div>
                {errors.amount && (
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white transition-all appearance-none hover:border-gray-400"
                >
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows="4"
                    className={`w-full pl-11 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-green-500 transition-all resize-none ${
                      errors.description ? 'border-red-500 bg-red-50' : 'border-gray-300 focus:border-green-500 hover:border-gray-400'
                    }`}
                  />
                </div>
                {errors.description && (
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
            <div className="flex flex-col sm:flex-row gap-4 justify-end">
              ...
              <button
                type="button"
                onClick={handleReset}
                className="flex items-center justify-center gap-2 px-6 py-3 bg-orange-100 hover:bg-orange-200 text-orange-700 rounded-xl transition-all font-semibold"
              >
                <X className="w-5 h-5" />
