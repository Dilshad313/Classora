...
const EmployeeReport = () => {
  ...
  const allAttendanceRecords = [
    { id: 1, date: '2024-11-08', day: 'Fri', employeeId: 'EMP001', name: 'Dr. Rajesh Kumar', role: 'Principal', department: 'Administration', status: 'P' },
    { id: 2, date: '2024-11-08', day: 'Fri', employeeId: 'EMP002', name: 'Mrs. Priya Sharma', role: 'Mathematics Teacher', department: 'Teaching', status: 'P' },
    { id: 3, date: '2024-11-08', day: 'Fri', employeeId: 'EMP003', name: 'Mr. Amit Patel', role: 'Science Teacher', department: 'Teaching', status: 'P' },
    { id: 4, date: '2024-11-08', day: 'Fri', employeeId: 'EMP004', name: 'Ms. Sneha Reddy', role: 'English Teacher', department: 'Teaching', status: 'L' },
    { id: 5, date: '2024-11-08', day: 'Fri', employeeId: 'EMP005', name: 'Mr. Vikram Singh', role: 'Sports Instructor', department: 'Sports', status: 'P' },
    { id: 6, date: '2024-11-07', day: 'Thu', employeeId: 'EMP001', name: 'Dr. Rajesh Kumar', role: 'Principal', department: 'Administration', status: 'P' },
    { id: 7, date: '2024-11-07', day: 'Thu', employeeId: 'EMP002', name: 'Mrs. Priya Sharma', role: 'Mathematics Teacher', department: 'Teaching', status: 'P' },
    { id: 8, date: '2024-11-07', day: 'Thu', employeeId: 'EMP003', name: 'Mr. Amit Patel', role: 'Science Teacher', department: 'Teaching', status: 'A' },
    { id: 9, date: '2024-11-07', day: 'Thu', employeeId: 'EMP004', name: 'Ms. Sneha Reddy', role: 'English Teacher', department: 'Teaching', status: 'P' },
    { id: 10, date: '2024-11-07', day: 'Thu', employeeId: 'EMP005', name: 'Mr. Vikram Singh', role: 'Sports Instructor', department: 'Sports', status: 'P' },
    { id: 11, date: '2024-11-06', day: 'Wed', employeeId: 'EMP006', name: 'Mrs. Anita Desai', role: 'Librarian', department: 'Library', status: 'P' },
    { id: 12, date: '2024-11-06', day: 'Wed', employeeId: 'EMP007', name: 'Mr. Suresh Nair', role: 'Lab Assistant', department: 'Laboratory', status: 'P' },
    { id: 13, date: '2024-11-06', day: 'Wed', employeeId: 'EMP008', name: 'Ms. Kavita Joshi', role: 'Computer Teacher', department: 'Teaching', status: 'P' },
    { id: 14, date: '2024-11-06', day: 'Wed', employeeId: 'EMP009', name: 'Mr. Ravi Verma', role: 'Accountant', department: 'Administration', status: 'L' },
    { id: 15, date: '2024-11-06', day: 'Wed', employeeId: 'EMP010', name: 'Mrs. Meera Iyer', role: 'HR Manager', department: 'Administration', status: 'P' },
    { id: 16, date: '2024-11-05', day: 'Tue', employeeId: 'EMP001', name: 'Dr. Rajesh Kumar', role: 'Principal', department: 'Administration', status: 'P' },
    { id: 17, date: '2024-11-05', day: 'Tue', employeeId: 'EMP002', name: 'Mrs. Priya Sharma', role: 'Mathematics Teacher', department: 'Teaching', status: 'P' },
    { id: 18, date: '2024-11-05', day: 'Tue', employeeId: 'EMP011', name: 'Mr. Arjun Menon', role: 'Physics Teacher', department: 'Teaching', status: 'P' },
    { id: 19, date: '2024-11-04', day: 'Mon', employeeId: 'EMP012', name: 'Ms. Divya Kapoor', role: 'Chemistry Teacher', department: 'Teaching', status: 'P' },
    { id: 20, date: '2024-11-04', day: 'Mon', employeeId: 'EMP013', name: 'Mr. Karan Malhotra', role: 'Biology Teacher', department: 'Teaching', status: 'A' }
  ];
  ...
  const handleCopy = () => {
    const text = currentRecords.map(r => 
      `${r.date}\t${r.day}\t${r.employeeId}\t${r.name}\t${r.role}\t${r.department}\t${r.status}`
    ).join('\n');
  ...
  const handleCSV = () => {
    const headers = 'DATE,DAY,EMPLOYEE ID,NAME,ROLE,DEPARTMENT,STATUS\n';
    ...
    a.href = url;
    a.download = 'employee_attendance_report.csv';
    a.click();
  };
