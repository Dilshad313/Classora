              ...
              {filteredStudents.map((student) => (
                <div
                  ...
                  className={`bg-white rounded-lg shadow-sm border p-4 cursor-pointer transition-all hover:shadow-md ${
                    selectedStudent?._id === student._id ? 'border-blue-500 ring-2 ring-blue-100' : 'border-gray-200'
                  }`}
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{student.registrationNo} • Grade {student.selectClass}</p>
                        </div>
                      </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    {selectedStudent.fatherName && (
                      <div className="border border-gray-200 rounded-lg p-4">
                        <h4 className="font-semibold text-gray-900 capitalize flex items-center space-x-2 mb-3">
                          <User className="w-4 h-4 text-blue-600" />
                          <span>Father Information</span>
                        </h4>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <p className="font-medium text-gray-900">{selectedStudent.fatherOccupation || 'Not specified'}</p>
                          </div>
                          <div>
                            <span className="text-gray-500">Mobile:</span>
                            <p className="font-medium text-gray-900">{selectedStudent.fatherMobile || 'Not specified'}</p>
                          </div>
                        </div>
                      </div>
                    )}
                    ...
                    {selectedStudent.motherName && (
                      <div className="border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                          <div>
                            <span className="text-gray-500">Name:</span>
                            <p className="font-medium text-gray-900">{selectedStudent.motherName}</p>
                          </div>
                          <div>
                            <span className="text-gray-500">Occupation:</span>
                            <p className="font-medium text-gray-900">{selectedStudent.motherOccupation || 'Not specified'}</p>
                          </div>
                          <div>
                            <span className="text-gray-500">Mobile:</span>
                            <p className="font-medium text-gray-900">{selectedStudent.motherMobile || 'Not specified'}</p>
                          </div>
                        </div>
                      </div>
                    )}
