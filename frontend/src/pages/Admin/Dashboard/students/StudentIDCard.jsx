                ...
                <div className="w-[350px] h-[550px] bg-white rounded-lg shadow-2xl overflow-hidden border border-gray-300 transform hover:scale-102 transition-transform duration-300 relative">
                  ...
                  <div className="px-6 py-6 bg-gradient-to-b from-gray-50 to-white">
                    <div className="flex flex-col items-center">
                      ...
                      <div className="text-center mb-4 w-full">
                        <h4 className="text-xl font-bold text-gray-900 mb-1">{student.studentName}</h4>
                  ...
                  <div className="px-6 pb-4 space-y-3">
                    ...
                    <div className="flex items-center justify-between py-2 border-b border-gray-200">
                      ...
                      <span className="text-sm font-bold text-gray-900 font-mono">{student.registrationNo}</span>
                    </div>

                    {/* Admission Number */}
                    {student.admissionNumber && (
                      <div className="flex items-center justify-between py-2 border-b border-gray-200">
                        <span className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Admission No</span>
                        <span className="text-sm font-bold text-gray-900 font-mono">{student.admissionNumber}</span>
                      </div>
                    )}
