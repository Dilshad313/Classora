...
const JobLetter = () => {
  ...
  const employees = [
    {
      ...
      emergencyContact: 'Mrs. Sunita Kumar',
      emergencyPhone: '+91 98765 43200',
      bloodGroup: 'O+',
    ...
    },
    {
      ...
      emergencyPhone: '+91 98765 43201',
      bloodGroup: 'A+',
      qualification: 'M.A Education, Ph.D',
      experience: '15 years',
      salary: '₹85,000',
      photo: null
    },
    {
      ...
      emergencyContact: 'Mrs. Neha Patel',
      emergencyPhone: '+91 98765 43202',
      bloodGroup: 'B+',
    ...
    },
    {
      ...
      emergencyContact: 'Mr. Mohan Reddy',
      emergencyPhone: '+91 98765 43203',
      bloodGroup: 'AB+',
  ...
  const filteredEmployees = employees.filter(employee => 
    ...
    employee.offerNumber.toLowerCase().includes(searchTerm.toLowerCase())
  );
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 mb-8 print:hidden">
          ...
          {searchTerm && filteredEmployees.length > 0 && (
            <div className="mt-4 border-t border-gray-200 pt-4 max-h-64 overflow-y-auto">
              <p className="text-sm font-semibold text-gray-600 mb-3">Search Results ({filteredEmployees.length})</p>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">
                        {employee.employeeId} • {employee.offerNumber} • {employee.role} - {employee.department}
                      </p>
                    </div>
                  </button>
                ))}
              ...
              <div className="flex flex-col md:flex-row gap-8 mb-8">
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-5 rounded-xl border-2 border-blue-100">
                    ...
                    <p className="text-xl font-bold text-gray-900 ml-13">{selectedEmployee.name}</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-5 rounded-xl border-2 border-purple-100">
                    ...
                    <p className="text-xl font-bold text-gray-900 ml-13">{selectedEmployee.offerNumber}</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-5 rounded-xl border-2 border-green-100">
                    ...
                    <p className="text-xl font-bold text-gray-900 ml-13">{selectedEmployee.employeeId}</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-orange-50 to-amber-50 p-5 rounded-xl border-2 border-orange-100">
                    ...
                    <p className="text-xl font-bold text-gray-900 ml-13">{selectedEmployee.role}</p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <div>
                      ...
                      <p className="text-base font-bold text-gray-900">{selectedEmployee.phone}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-base font-bold text-gray-900 break-all">{selectedEmployee.email}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <div>
                      ...
                      <p className="text-base font-bold text-gray-900">{selectedEmployee.bloodGroup}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <div>
                      ...
                      <p className="text-base font-bold text-gray-900">{selectedEmployee.department}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <div>
                      ...
                      <p className="text-base font-bold text-gray-900">{selectedEmployee.qualification}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-base font-bold text-gray-900">{selectedEmployee.address}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-2xl border-2 border-blue-200">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{selectedEmployee.experience}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-6 rounded-2xl border-2 border-amber-200 mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-lg font-bold text-gray-900">{selectedEmployee.emergencyContact}</p>
                  </div>
                  <div>
                    <p className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1">Contact Phone</p>
                    <p className="text-lg font-bold text-gray-900">{selectedEmployee.emergencyPhone}</p>
                  </div>
                </div>
              </div>
